...
public class FileUtilities {
	...
	int countWords(StringBuilder fileContent) {
		int wordCount = 0;
		// create string array to store all words in fileContent after converting to string and splitting at white space.
	 ...
	 * to count the number of times the searchString is found, and second time to
	 * store its positions.
	 */
